...
@section('nav')
                            <li class="nav-item active">
			                    <a class="nav-link" href="/admin/profile"><font color="#1b9ad9"><i class="fa fa-university"></i> {{session('LoggedUAdm')}}</font></a>
			                </li>
                            <li class="nav-item active">
...
<div class="body1">
    <div class="maildet">
		<p><h3 ><font color="#1e81b0">Ajouter un Admin</font></h3></p><br>
        <form action="{{url('/saveadmin')}}" class="form-contact" method="POST" enctype="multipart/form-data">
            @csrf
...
<div style="text-align: right; margin-right:120px ;">
	<br><div  class="text-right" ><a href="{{url('/admin/profile')}}"><button class="btn btn-primary"><i class="fa fa-undo"></i>  retour</button></a></div>
</div> 
</div>
</div>
<br><br><br>
