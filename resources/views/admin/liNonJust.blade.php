...
@section('content')
<br><br>
<h3 style="margin-left: 100px;"><font color="#1b9ad9"><i class="fa fa-list"></i> Absences non Justifiée :</font></h3><br>
<table  class="content-tab" style="width: 1050px; margin-left:100px;" >
						...
						<tr>
							<th><img src="/images/{{$det->image}}" alt="student image" height="50px" width="auto"></th>
							<th>{{$det->nomc}}</th>
							<th>{{$det->cne}}</th>
							<th>{{$det->fill}}</th>
							<th>{{$det->niveau}}</th>
							...
							@if(!empty($det->justification))
									<th><a id="myBtn" style="cursor: pointer;">v<i class="fa fa-eye"></i>ir</a></th>
									<div id="myModal" class="modal">
										<div class="modal-content">
											<span class="close">&times;</span>
											<img src="/images/{{$det->justification}}" alt="justification">
										</div>
									</div>
									<script>
									...
									<form action="{{route('justi.accept',$det->id)}}" method="post">
										@csrf
										<th>
											@if(Session::get('fail'))
										...
										<th><button type="submit" class="bta">accept</button></th>
									</form>
									<th><a href="{{route('justi.refuse',$det->id)}}"><button class="btf">refuse</button></a></th>
							@else
								<th>aucune justification</th>
							@endif
						</tr>
						@endforeach
		</table><br><br>
